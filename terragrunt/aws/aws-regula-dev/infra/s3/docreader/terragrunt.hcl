...
inputs = {
  bucket = "${local.project.project_name}-${local.project.project_env}-docreader"
  ...
  tags = {
    Name        = "${local.project.project_name}-${local.project.project_env}-docreader"
    Application = "docreader"
  }
}